            ...
            <div className="relative m-4 w-full max-w-md rounded-2xl bg-white/90 p-8 shadow-2xl backdrop-blur-lg">
                ...
                <div className="flex rounded-lg bg-gray-200 p-1 mb-6">
                    <button
                        ...
                        className={`w-1/2 rounded-md py-2 text-sm font-medium transition-all duration-300 ${isLogin ? 'bg-white shadow-md text-blue-600' : 'text-gray-500 hover:bg-gray-300/50'}`}
                    >
                        Login
                    </button>
                    <button
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    {!isLogin && (
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className="w-full rounded-lg border border-gray-300 bg-gray-50 py-2.5 pl-10 pr-3 text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div>
                        <button
                            type="submit"
                            className="w-full rounded-lg bg-blue-600 px-5 py-3 text-center text-sm font-semibold text-white shadow-md hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 transition-all duration-300"
                        >
